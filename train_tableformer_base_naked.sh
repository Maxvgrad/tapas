#!/bin/bash -l
#SBATCH --job-name="nlp-project-train-bert-base-naked"
...
FT_RESULTS_DIR="ft_result_tableformer_base_naked/wtq"
PRETRAIN_RESULTS_DIR="pretrain_results_bert_base_naked"
BERT_CONFIG_DIR="uncased_L-12_H-768_A-12"
...
python tapas/experiments/tapas_classifier_experiment.py \
  ...
  --init_checkpoint="${BASE_DIR}/${PRETRAIN_RESULTS_DIR}/wtq/model" \
