#!/bin/bash -l
#SBATCH --job-name="nlp-project-evaluate-pretrain-bert-base-5pp-extended"
...
python tapas/experiments/tapas_pretraining_experiment.py \
  ...
  --num_train_examples=32000000 \
  --max_seq_length=128 \
  --compression_type="" \
  --input_file_train="pretrain_5pp/train.tfrecord" \
  --input_file_eval="pretrain_5pp/test.tfrecord" \
  --init_checkpoint="uncased_L-12_H-768_A-12/bert_model.ckpt" \
  --bert_config_file="uncased_L-12_H-768_A-12/bert_config.json" \
  --model_dir="pretrain_results_bert_base_5pp_extended/wtq/model" \
