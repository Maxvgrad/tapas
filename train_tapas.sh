...
FT_RESULTS_DIR="ft_result_tapas_masklm_tiny/wtq"
PRETRAIN_RESULTS_DIR="pretrain_results_bert_tiny_5pp_extended/wtq"
...
python tapas/experiments/tapas_classifier_experiment.py \
  ...
  --init_checkpoint="${BASE_DIR}/${PRETRAIN_RESULTS_DIR}/model" \
