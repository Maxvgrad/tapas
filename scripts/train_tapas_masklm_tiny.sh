#!/bin/bash -l
#SBATCH --job-name="nlp-project-train-tapas-masklm-tiny"
...
FT_RESULTS_DIR="ft_results_tapas_masklm_tiny/wtq"
PRETRAIN_RESULTS_DIR="tapas_masklm_tiny"
BERT_CONFIG_DIR="tapas_masklm_tiny"
