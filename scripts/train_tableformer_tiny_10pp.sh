#!/bin/bash -l
#SBATCH --job-name="nlp-project-train-tiny-10pp"
...
FT_RESULTS_DIR="ft_results_bert_tiny_10pp/wtq"
PRETRAIN_RESULTS_DIR="pretrain_results_bert_tiny_10pp_extended"
BERT_CONFIG_DIR="uncased_L-2_H-128_A-2"
